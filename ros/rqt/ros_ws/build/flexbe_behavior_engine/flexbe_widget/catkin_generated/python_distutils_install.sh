...
echo_and_run cd "/home/ros_ws/src/flexbe_behavior_engine/flexbe_widget"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/flexbe_behavior_engine/flexbe_widget/setup.py" \
     \
    build --build-base "/home/ros_ws/build/flexbe_behavior_engine/flexbe_widget" \
    install \
    --root="${DESTDIR-/}" \
