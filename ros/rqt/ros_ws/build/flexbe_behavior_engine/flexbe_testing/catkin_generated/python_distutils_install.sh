...
echo_and_run cd "/home/ros_ws/src/flexbe_behavior_engine/flexbe_testing"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/flexbe_behavior_engine/flexbe_testing/setup.py" \
     \
    build --build-base "/home/ros_ws/build/flexbe_behavior_engine/flexbe_testing" \
    install \
    --root="${DESTDIR-/}" \
