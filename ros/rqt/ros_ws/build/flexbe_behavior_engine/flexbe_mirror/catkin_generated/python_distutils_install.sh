...
echo_and_run cd "/home/ros_ws/src/flexbe_behavior_engine/flexbe_mirror"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/flexbe_behavior_engine/flexbe_mirror/setup.py" \
     \
    build --build-base "/home/ros_ws/build/flexbe_behavior_engine/flexbe_mirror" \
    install \
    --root="${DESTDIR-/}" \
